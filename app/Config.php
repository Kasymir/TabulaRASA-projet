...
class Config
{
    ...
    public function __construct()
    {
         ...
         */
        define('SITEURL', 'http://localhost/TabulaRASA-projet/');

        /**
         * Define relative base path.
         */
        define('DIR', '/TabulaRASA-projet/');
         ...
         */
        define('SESSION_PREFIX', 'yolo_');

        /**
         * Optional create a constant for the name of the site.
         */
        define('SITETITLE', 'TabulaRASA');
