...
<head>
    ...
    Assets::css([
        ...
        Url::templatePath().'bower_components/morrisjs/morris.css',
...
<!-- <p><img src='<?=Url::templatePath();?>images/nova.png' alt='<?=SITETITLE;?>'></p> -->
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top navbar-inverse" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar navbar-inserve" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Instruments<span class="fa arrow"></span></a>
